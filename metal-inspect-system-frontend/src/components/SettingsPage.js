            ...
            <div className="header">
                <div className="logo-section">
                    ...
                    <div className="logo-text">
                        <h1>Metal Inspect</h1>
                        <div className="subtitle">Система распознавания трещин в слитках • Настройки системы</div>
                    </div>
                </div>
                ...
                <div className="nav-buttons">
                    ...
                    <a href="/settings" className="nav-btn active">
                ...
                <div className="user-info">
                    ...
                    <div>
                        <div className="user-name">Администратор Сидоров И.В.</div>
                        <div className="user-role">Уровень доступа: Администратор</div>
                    </div>
                </div>
            </div>
