...
//         balancedConfidenceThreshold,
//         sensitiveConfidenceThreshold,
//         strictIouThreshold,
//         balancedIouThreshold,
//         sensitiveIouThreshold,
//       }) => {
//         if (modelType === "detection") {
//           return {
//             strict: {
//               confidence_threshold: strictConfidenceThreshold,
//               iou_threshold: strictIouThreshold,
//             },
//             balanced: {
//               confidence_threshold: balancedConfidenceThreshold,
//               iou_threshold: balancedIouThreshold,
//             },
//             sensitive: {
//               confidence_threshold: sensitiveConfidenceThreshold,
//               iou_threshold: sensitiveIouThreshold,
//             },
//           };
//         }
...
//           },
//           balanced: {
//             threshold: balancedThreshold,
//           },
//           sensitive: {
//             threshold: sensitiveThreshold,
//           },
//         };
//       };
                ...
                {showCreateForm && canManageAiModels && (
                  <div className="ai-create-model-form">
                    ...
                    <div className="ai-create-model-note">
                      Файл весов сейчас не загружается через интерфейс. Нужно
                      указать путь к уже размещённому файлу, например{" "}
                      <code>./models_ml/best_weighted.pt</code>. Значения режимов{" "}
                      <strong>strict</strong>, <strong>balanced</strong> и{" "}
                      <strong>sensitive</strong> задаются вручную при создании модели.
                    </div>
                  </div>
                )}
